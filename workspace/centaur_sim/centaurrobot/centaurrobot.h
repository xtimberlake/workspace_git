 ...
 * @LastEditors: haoyun 
 * @LastEditTime: 2023-06-19 22:02:26
...
public:
    ...
    
    {
        ...
        walking = new CentuarGaitPattern(0.8, ctrl_states.ctrl_params_const, Eigen::Vector2f(0.65, 0.65), Eigen::Vector2f(0.0, 0.5)); 
        // walking = new CentuarGaitPattern(1.0, ctrl_states.ctrl_params_const, Eigen::Vector2f(0.75, 0.75), Eigen::Vector2f(0.0, 0.5)); 
